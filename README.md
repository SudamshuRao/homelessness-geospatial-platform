...
Enriches each hex with counts from 15+ facility categories:
 Transit
 Healthcare
 Businesses
 Childcare
...
Data and config mounted as volumes (no hardcoded paths)
...
Designed a modular ETL pipeline with clear data contracts
